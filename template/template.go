...
import (
	...
	errors2 "github.com/backyio/go-admin/modules/errors"
	"github.com/backyio/go-admin/modules/language"
	"github.com/backyio/go-admin/modules/logger"
	"github.com/backyio/go-admin/modules/menu"
	...
	"github.com/backyio/go-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/backyio/go-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/backyio/go-admin/blob/master/template/login/list.go
	GetAssetList() []string
