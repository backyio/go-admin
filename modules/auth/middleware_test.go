...
func TestCheckPermissions(t *testing.T) {
	...
	assert.Equal(t, CheckPermissions(user, "/admin/info/user", "get", param), true)
	assert.Equal(t, CheckPermissions(user, "/admin/info/normal_manager/edit?__admin_edit_pk=2&__columns=id,roles,created_at,updated_at", "get", param), true)
	assert.Equal(t, CheckPermissions(user, "/admin/info/normal_manager/edit?__admin_edit_pk=2", "get", param), true)
	assert.Equal(t, CheckPermissions(user, "/admin/info/normal_manager/edit?__admin_edit_pk=3&__columns=id,roles,created_at,updated_at", "get", param), false)
	...
	assert.Equal(t, CheckPermissions(user, "/admin/info/user_list?__admin_edit_pk=3&user_type=20", "get", param), true)
